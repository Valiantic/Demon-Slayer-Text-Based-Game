...
# Game setup
player_name = "Aoi Kenzaki"
player_attacks = ["First Form: Unknowing Fire ", "Second Form: Rising Scorching Sun ", "Third Form: Blazing Universe ", "Fourth Form: Blooming Flame Undulation"]  # Replace with your desired attacks
