...
# Game setup
player_name = "Kasumi Arashi"
player_attacks = ["First Form: Dust Whirlwind Cutter  ", "Second Form: Claws-Purifying Wind", "Third Form: Clear Storm Wind Tree ",]  # Replace with your desired attacks

player = Character(player_name, 100, 9, player_attacks)
